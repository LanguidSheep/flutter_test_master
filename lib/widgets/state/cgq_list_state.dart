...
/// cgq_list_state：上下拉刷新列表的通用State
/// Created by Chen_Mr on 2019/6/27.

mixin CGQListState<T extends StatefulWidget>
  ...
  final CGQPullLoadWidgetControl pullLoadWidgetControl =
      new CGQPullLoadWidgetControl();
