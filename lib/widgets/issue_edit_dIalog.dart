                      ...
                      child: new Column(
                        ...
                        children: <Widget>[
                          ...
                          new Padding(
                              ...
                              child: new Center(
                                child: new Text(widget.dialogTitle, style: CGQTextsConstant.normalTextBold),
                              )),
                          ...
                          new Container(
                            ...
                            decoration: new BoxDecoration(
                              ...
                              border: new Border.all(color: Color(CGQColorsConstant.subTextColor), width: .3),
                            ),
                            ...
                            children: <Widget>[
                              ...
                              new Expanded(
                                  child: new RawMaterialButton(
                                      ...
                                      constraints: const BoxConstraints(minWidth: 0.0, minHeight: 0.0),
                                      child: new Text(CommonUtils.getLocale(context).app_cancel, style: CGQTextsConstant.normalSubText),
                                      onPressed: () {
                                        Navigator.pop(context);
                                      })),
                              new Container(width: 0.3, height: 25.0, color: Color(CGQColorsConstant.subTextColor)),
                              ...
                              new Expanded(
                                  child: new RawMaterialButton(
                                      ...
                                      padding: EdgeInsets.all(4.0),
                                      constraints: const BoxConstraints(minWidth: 0.0, minHeight: 0.0),
                                      child: new Text(CommonUtils.getLocale(context).app_ok, style: CGQTextsConstant.normalTextBold),
...
var FAST_INPUT_LIST = [
  FastInputIconModel(CGQIConsConstant.ISSUE_EDIT_H1, "\n# "),
  FastInputIconModel(CGQIConsConstant.ISSUE_EDIT_H2, "\n## "),
  FastInputIconModel(CGQIConsConstant.ISSUE_EDIT_H3, "\n### "),
  FastInputIconModel(CGQIConsConstant.ISSUE_EDIT_BOLD, "****"),
  FastInputIconModel(CGQIConsConstant.ISSUE_EDIT_ITALIC, "__"),
  FastInputIconModel(CGQIConsConstant.ISSUE_EDIT_QUOTE, "` `"),
  FastInputIconModel(CGQIConsConstant.ISSUE_EDIT_CODE, " \n``` \n\n``` \n"),
  FastInputIconModel(CGQIConsConstant.ISSUE_EDIT_LINK, "[](url)"),
];
