...
import '../cgq_pull_load_widget.dart';
import 'nested_refresh.dart';

///通用下上刷新控件
class CGQNestedPullLoadWidget extends StatefulWidget {
  ///item渲染
  ...
  @override
  _CGQNestedPullLoadWidgetState createState() => _CGQNestedPullLoadWidgetState(
      this.control,
      this.itemBuilder,
      this.onRefresh,
      this.onLoadMore,
...
class _CGQNestedPullLoadWidgetState extends State<CGQNestedPullLoadWidget> {
  final IndexedWidgetBuilder itemBuilder;
  ...
  _CGQNestedPullLoadWidgetState(this.control, this.itemBuilder, this.onRefresh,
