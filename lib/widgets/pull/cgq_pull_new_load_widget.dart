...
import 'package:flutter_test_master/widgets/pull/cgq_refresh_sliver.dart'
    as IOS;
...
import 'cgq_flare_pull_controller.dart';
...
class CGQPullLoadWidget extends StatefulWidget {
  ...
  @override
  _CGQPullLoadWidgetState createState() => _CGQPullLoadWidgetState();
}

class _CGQPullLoadWidgetState extends State<CGQPullLoadWidget>
    with CGQFlarePullController {
...
class CGQPullLoadWidgetControl extends ChangeNotifier {
  ///数据，对齐增减，不能替换
