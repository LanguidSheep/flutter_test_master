...
import 'package:flutter_test_master/bloc/trend_bloc.dart';
...
import 'package:flutter_test_master/widgets/cgq_card_item.dart';
...
class _TrendPageState extends State<TrendPage>
  ...
  ///绘制头部可选item
  _renderHeader(Store<CGQState> store, Radius radius) {
  ...
  _renderHeaderPopItem(String data, List<TrendTypeModel> list,
    ...
    return new Expanded(
      child: new PopupMenuButton<TrendTypeModel>(
        child: new Center(
            child: new Text(data, style: CGQTextsConstant.middleTextWhite)),
